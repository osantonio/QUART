...
routes = [configuracion_bp, auth_bp, main_bp, usuarios_bp, me_bp, roles_bp, permisos_bp, beneficiarios_bp, signos_vitales_bp, imc_bp, farmacia_bp, visitantes_bp, parentescos_bp, hclinica_bp]
